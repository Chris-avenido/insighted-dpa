...
**This file (`antigravity-brain.md`) is a global standard** — the process rules,
...
a new project using this one as a reference, copy this
`antigravity-brain.md` (and its Claude Code counterpart) as the
starting standard, but generate a fresh `docs/` folder for the new
project rather than duplicating this one's contents.
